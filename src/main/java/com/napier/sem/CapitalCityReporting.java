...
public class CapitalCityReporting {
    public void RunSamples(){
        ...
        // Report 02 - Capital cites by population
        System.out.println("Report 02 - Top N Populated Capital Cities In The World");
        System.out.println("Parameters: Top N Populated Capital Cities = 5");
        ArrayList<City> capitalCities02 = new ArrayList<City>();
        capitalCities02 = getTopNCapitalCitiesInTheWorld("5");
